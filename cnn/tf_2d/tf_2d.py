...
valid_param = Param("../../fenics/output/run_1_valid", "../../qsgs_3d/output/run_1_valid", 0, 499)
train_param = Param("../../fenics/output/run_2_train", "../../qsgs_3d/output/run_2_train", 0, 1999)
